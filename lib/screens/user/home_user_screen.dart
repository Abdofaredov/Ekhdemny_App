...
import 'package:ekhdemny/screens/user/create_order_screen.dart';
...
class HomeUserScreen extends StatelessWidget {
  ...
  List<TechnicalsModel> technicalList = [
    TechnicalsModel(
        typeTechnical: 'Electrician', image: 'assets/images/electrician.jpeg'),
    TechnicalsModel(
        typeTechnical: 'Mechanical technician',
        image: 'assets/images/mechanical.jpeg'),
    TechnicalsModel(
        typeTechnical: 'Air conditioning refrigeration',
              ...
              child: Column(
                ...
                children: [
                  SizedBox(
                    ...
                    child: Marquee(
                      text:
                          'Welcome ${cubit.userModel == null ? '' : cubit.userModel!.fullName} to Ekhdemny   ',
                    ),
                  ),
                  Container(
                              ...
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                      builder: (context) => CreateOrderScreen(
                                            typeTechnical: technicalList[index]
                                                .typeTechnical,
                                          )));
                            },
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Expanded(
                                      child: Image.asset(
                                          technicalList[index].image)),
                                  const SizedBox(
                                    height: 5,
                                  ),
                                  Text(
                                    technicalList[index].typeTechnical,
                              ...
                              child: Column(
                                ...
                                children: [
                                  RichText(
                                    ...
                                    TextSpan(
                                      text: cubit
                                          .ordersFinishUserList[index].idOrder,
                                      style: const TextStyle(
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Text(
                                        cubit.ordersFinishUserList[index]
                                            .userName,
                                        textAlign: TextAlign.center,
                                        overflow: TextOverflow.visible,
                                        softWrap: true,
                                  ...
                                  RichText(
                                    ...
                                    TextSpan(
                                      text: cubit.ordersFinishUserList[index]
                                          .technicalId,
                                      style: const TextStyle(
                                        overflow: TextOverflow.ellipsis,
                                        color: Colors.orange,
                                  ...
                                  RichText(
                                    ...
                                    TextSpan(
                                      text:
                                          '${cubit.ordersFinishUserList[index].price} EGP',
                                      style: const TextStyle(
                                        overflow: TextOverflow.ellipsis,
                                        color: Colors.orange,
                                        fontSize: 18,
