                          ...
                          child: Column(
                            ...
                            children: [
                                ...
                                children: [
                                  CircleAvatar(
                                    backgroundImage: NetworkImage(
                                      cubit.ordersUserList[index].imageOrder,
                                    ),
                              ...
                              RichText(
                                ...
                                TextSpan(
                                  text:
                                      cubit.ordersUserList[index].typeTechnical,
                                  style: const TextStyle(
                              ...
                              RichText(
                                ...
                                TextSpan(
                                  text: cubit
                                      .ordersUserList[index].currentLocation,
                                  style: const TextStyle(
                                    overflow: TextOverflow.ellipsis,
                                    color: Colors.white,
                                    fontSize: 18,
                              ...
                              RichText(
                                ...
                                TextSpan(
                                  text: cubit.ordersUserList[index].technicalId,
                                  style: const TextStyle(
                                    overflow: TextOverflow.ellipsis,
                                    color: Colors.white,
                                    fontSize: 18,
                              ...
                              RichText(
                                ...
                                TextSpan(
                                  text: cubit.ordersUserList[index].details,
                                  style: const TextStyle(
                                    overflow: TextOverflow.ellipsis,
                                    color: Colors.white,
                                    fontSize: 18,
                              ...
                              RichText(
                                ...
                                TextSpan(
                                  text: cubit.ordersUserList[index].status,
                                  style: const TextStyle(
                                    overflow: TextOverflow.ellipsis,
                                    color: Colors.white,
                                    fontSize: 18,
                              ...
                              RichText(
                                ...
                                TextSpan(
                                  text:
                                      '${cubit.ordersUserList[index].price} EGP',
                                  style: const TextStyle(
                                    overflow: TextOverflow.ellipsis,
                                    color: Colors.white,
                                    fontSize: 18,
