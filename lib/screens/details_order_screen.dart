...
import 'package:ekhdemny/model/order_model.dart';
import 'package:ekhdemny/screens/layout_screen.dart';
import 'package:ekhdemny/screens/technical/route_map.dart';
...
class _MoreDetailOrderState extends State<MoreDetailOrder> {
    ...
    try {
      await http.post(
        ...
        headers: <String, String>{
          ...
          'Authorization':
              'key=AAAAwEcATXA:APA91bGOaYxBoFaNwKzKZC4LyoYBSdyUa0X3cT0IY1ls6TlFbe1R46NPcFDAP2MMZSQ4q4UawnLgYQ14GIjnFDwKOCTSxJRp2Y6iHbLe-65lR6FqT93KLEiVdq8WV9f1DClq1TN9gVTD',
        },
        body: jsonEncode(
          <String, dynamic>{
  ...
  void getToken() async {
    await FirebaseFirestore.instance
        ...
        .doc(widget.orderModel.userId.toString())
        .get()
        .then((value) {
      setState(() {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<AppCubit, AppStates>(builder: (context, state) {
              ...
              children: [
                ...
                RichText(
                  text: TextSpan(children: [
                    ...
                    TextSpan(
                      text: widget.orderModel.details,
                      style: const TextStyle(
                        overflow: TextOverflow.ellipsis,
                        color: Colors.orange,
                        fontSize: 18,
                ...
                RichText(
                  ...
                  TextSpan(
                    text: widget.orderModel.idOrder,
                    style: const TextStyle(
                      overflow: TextOverflow.ellipsis,
                      color: Colors.orange,
                      fontSize: 18,
                ...
                RichText(
                  ...
                  TextSpan(
                    text: widget.orderModel.createdAt.toString(),
                    style: const TextStyle(
                      overflow: TextOverflow.ellipsis,
                      color: Colors.orange,
                      fontSize: 18,
                ...
                RichText(
                  ...
                  TextSpan(
                    text: widget.orderModel.price.toString(),
                    style: const TextStyle(
                      overflow: TextOverflow.ellipsis,
                      color: Colors.orange,
                      fontSize: 18,
                  ...
                  child: MaterialButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => CurrentLocationTechnical(
                ...
                Row(
                  ...
                  children: [
                    CircleAvatar(
                      ...
                      backgroundImage:
                          NetworkImage(widget.orderModel.userImage),
                    ),
                    const SizedBox(
                      width: 10,
                    ),
                ...
                Row(
                  ...
                  children: [
                    ...
                    IconButton(
                        onPressed: () async {
                          String number =
                              widget.orderModel.userPhone; //set the number here
      ...
      if (state is SuccessOrderConfirm) {
        ...
        sendPushMessage(
          mtoken!,
          'ConFirm Order ${widget.orderModel.userName} By ${BlocProvider.of<AppCubit>(context).userModel!.userName}',
          'Confirm Order',
        );
        BlocProvider.of<AppCubit>(context).addNotification(
            name: BlocProvider.of<AppCubit>(context).userModel!.userName,
            ...
            typeAccount:
                BlocProvider.of<AppCubit>(context).userModel!.typeAccount,
            country: BlocProvider.of<AppCubit>(context).userModel!.city,
...
class CurrentLocationTechnical extends StatefulWidget {
  ...
  const CurrentLocationTechnical({
    super.key,
    required this.latOrder,
    required this.lngOrder,
  });

  @override
  State<CurrentLocationTechnical> createState() =>
      _CurrentLocationTechnicalState();
}
